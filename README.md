...
Includes detailed annotations, layer-by-layer explanations, and a re-implementation from scratch for educational insight.

**Key Features:**
- Layer-wise code for Conv2D, MaxPooling, LRN, Dropout, and Dense layers  
- GPU-based computation insights and model architecture walkthrough  
...
- Training visualizations and hyperparameter tuning  
...
Includes tasks like summarization, NER, and dialogue fine-tuning.

**Includes:**
- LoRA fine-tuning on T5 and FLAN models (`LoRA_Finetuning.ipynb`)  
- ClinicalBERT fine-tuning for NER (`FineTuning_ClinicalBert_NER.ipynb`)  
- Evaluation using ROUGE metrics (ROUGE-1, ROUGE-2, ROUGE-L, ROUGE-Lsum)
